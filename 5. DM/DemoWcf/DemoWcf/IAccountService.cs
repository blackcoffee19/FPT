...
namespace DemoWcf
{
    ...
    public interface IAccountService
    {
        ...
        [OperationContract]
        [WebInvoke(Method = "POST", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json, UriTemplate = "/api/account")]
        Task<int> Create(AccountContract acc);
    }
}
